              ...
              <div className="article-content ">
                ...
                <div className="whitespace-pre-line px-2">
                  ...
                  <p className="mt-10">
                    ...
                    <p>
                      {" "}
                      <strong>Frank W. Bond, and David Bunce</strong>. 2003. "The Role of Acceptance
                      and Job Control in Mental Health,Job Satisfaction, and Work Performance."
                      Journal of Applied Psychology 1057-1067.
                    </p>
                  </p>
                </div>
              </div>
