...
const db = require("./db") // เรียกใช้ mysql
const app = express() // สร้าง Object เก็บไว้ในตัวแปร app เพื่อนำไปใช้งาน
const cors = require("cors")

const instructors = require("./api/instructor")
const instructorsFind = require("./api/instructor-find")
const instructorsAdd = require("./api/instructor-add")
const instructorsUpdate = require("./api/instructor-update")
const instructorsContact = require("./api/instructor-contact")
...
app.use("/api/instructor", instructors)
app.use("/api/instructor/:id", instructorsFind)
app.use("/api/instructor/add", instructorsAdd)
app.use("/api/instructors/update/:id", instructorsUpdate)
app.use("/api/instructors/contact", instructorsContact)
