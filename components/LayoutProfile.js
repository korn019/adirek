            ...
            <div className="navbar bg-base-100 lg:hidden sticky top-0 w-full z-50">
              ...
              <div className="flex-1">
                <a className="btn btn-ghost normal-case text-xl text-white" href="">
                  {(auth.EditUser && auth.user?.type == "student") ||
                  auth.user?.type == "instructor"
                    ? `${auth.EditUser?.first_name} ${auth.EditUser?.last_name}`
                    : auth.EditUser && auth.user?.type == "institution"
            ...
            <div className="w-fit p-3 lg:m-6 bg-base-100  ">
              ...
              <div className=" ">
                {Object.keys(auth).length !== 0 ? (
                  <div className="text-center flex justify-center">
                    <div className=" w-40 h-40 bg-red-50  rounded-full  text-center flex items-center justify-center ">
                      <span className="text-black text-Athiti !text-f3xl !font-semibold">
                        {auth.EditUser
                          ? auth.EditUser?.first_name.charAt(0) + auth.EditUser?.last_name.charAt(0)
                ...
                <div className="bg-[rgb(245,245,255)]  rounded-box menu mt-2">
                  ...
                  <h1 className="text-2xl p-2 pl-4 text-black text-center">
                    ...
                    {auth.EditUser ? `${auth.EditUser?.first_name}` : `${auth.user?.first_name}`}
                  </h1>
                  <h1 className="text-2xl p-2 pl-4 text-black text-center">
                    {auth.EditUser ? `${auth.EditUser?.last_name}` : `${auth.user?.last_name}`}
                  </h1>
              ...
              <div className="pt-4 ">
                <ul className="menu  bg-[rgb(245,245,255)] rounded-box">
                  <li>
                    <Link href={`/user/profile/${auth.user?.first_name}`}>
                      <a>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-5 w-5"
